...
function Field({
  ...
  const base =
    "w-full px-3 py-2.5 border border-linen-300 rounded-md bg-white font-sans text-sm text-ink-900 placeholder-ink-300 focus:outline-none focus:border-bronze-400 transition-colors";
  return (
    <div>
      <label
        htmlFor={`field-${name}`}
        className="block font-sans text-xs uppercase tracking-widest text-ink-400 mb-1"
      >
        {label}
      </label>
      {multiline ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <SectionCard title="Location">
            <Field
              ...
              value={propertyData.formatted_address}
          ...
          <SectionCard title="Characteristics">
            ...
            <Field
              label="Assessor ID"
              name="assessor_id"
              value={propertyData.assessor_id}
              onChange={handleInputChange}
            />
            <Field
          ...
          <SectionCard title="Sale Information">
              ...
              <DatePicker
                value={
                  propertyData.last_sale_date
                    ? new Date(propertyData.last_sale_date)
                    : null
                }
            ...
            <Field
              ...
              value={propertyData.last_sale_price}
              onChange={handleInputChange}
              type="number"
            />
            <Checkbox
              ...
              name="owner_occupied"
              checked={propertyData.owner_occupied}
              onChange={handleInputChange}
            />
          </SectionCard>
          ...
          <SectionCard title="Features">
            <Field
              ...
              value={propertyData.features?.architecture_type}
              onChange={handleFeatureChange}
            />
            <Checkbox
              label="Cooling"
              name="cooling"
              checked={propertyData.features?.cooling}
              onChange={handleFeatureChange}
            />
            <Field
              label="Cooling Type"
              name="cooling_type"
              value={propertyData.features?.cooling_type}
              onChange={handleFeatureChange}
            />
            <Field
              label="Exterior Type"
              name="exterior_type"
              value={propertyData.features?.exterior_type}
              onChange={handleFeatureChange}
            />
            <Field
              label="Floor Count"
              name="floor_count"
              value={propertyData.features?.floor_count}
              onChange={handleFeatureChange}
              type="number"
            />
            <Field
              ...
              value={propertyData.features?.foundation_type}
              onChange={handleFeatureChange}
            />
            <Checkbox
              label="Garage"
              name="garage"
              checked={propertyData.features?.garage}
              onChange={handleFeatureChange}
            />
            <Field
              label="Garage Type"
              name="garage_type"
              value={propertyData.features?.garage_type}
              onChange={handleFeatureChange}
            />
            <Checkbox
              label="Heating"
              name="heating"
              checked={propertyData.features?.heating}
              onChange={handleFeatureChange}
            />
            <Field
              label="Heating Type"
              name="heating_type"
              value={propertyData.features?.heating_type}
              onChange={handleFeatureChange}
            />
            <Checkbox
              label="Pool"
            ...
            <Field
              label="Roof Type"
              name="roof_type"
              value={propertyData.features?.roof_type}
              onChange={handleFeatureChange}
            />
            <Field
              label="Room Count"
              name="room_count"
              value={propertyData.features?.room_count}
              onChange={handleFeatureChange}
              type="number"
            />
            <Field
              label="Unit Count"
              name="unit_count"
              value={propertyData.features?.unit_count}
              onChange={handleFeatureChange}
              type="number"
            />
          </SectionCard>
