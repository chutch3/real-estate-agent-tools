        ...
        {property && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
              ...
              >
                <p className="font-sans text-xs uppercase tracking-widest text-ink-400 mb-1.5">
                  Address
                </p>
                  ...
                  <ul className="space-y-1" role="list">
                    ...
                    {uploadingFileName && (
                      ...
                      >
                        ...
                        />
                        <span className="font-sans text-sm text-ink-400 italic">
                          {uploadingFileName}
                        </span>
                      </li>
                    )}
