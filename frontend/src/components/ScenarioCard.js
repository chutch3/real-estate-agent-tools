  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-4 space-y-3 flex-1">
        <div>
          <label className={labelClass} htmlFor={`sale_price-${scenario.id}`}>
            Sale Price
          </label>
          <input
        ...
        <div>
          <label
            ...
            htmlFor={`mortgage_payoff-${scenario.id}`}
          >
            Mortgage Payoff
          </label>
          <input
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            <label
              className={labelClass}
              htmlFor={`listing_commission_pct-${scenario.id}`}
            >
              Listing Commission %
            </label>
            <input
          ...
          <div className="flex-1">
            <label
              className={labelClass}
              htmlFor={`buyers_agent_commission_pct-${scenario.id}`}
            >
        ...
        <div>
          <label
            className={labelClass}
            htmlFor={`seller_concessions-${scenario.id}`}
          >
            Seller Concessions
          </label>
          <input
        ...
        <div>
          <label className={labelClass} htmlFor={`closing_date-${scenario.id}`}>
            Closing Date
          </label>
          <input
        ...
        <div>
          <label
            className={labelClass}
            htmlFor={`annual_tax_amount-${scenario.id}`}
          >
            Prior Year Annual Tax
          </label>
          <input
